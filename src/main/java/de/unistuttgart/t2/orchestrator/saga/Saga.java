 ...
 * 
 * <p>
 * For each saga definition exists a
 * {@link io.eventuate.tram.sagas.orchestration.SagaManager SagaManager}, that
 * manages the instances of the saga and executes the actions and compensations
 * as defined in the saga.
 * 
 * <p>
 * This saga has three participants: inventory, payment and order.
 * 
 * <p>
 * Order for creating and rejecting and orders, payment for executing the
 * payment (payment is the pivot step) and inventory to manage the product's
 * stockpiles.
 * 
 * 
 * 
...
public class Saga implements SimpleSaga<SagaData> {
    ...
    /**
     * Create a message that triggers an action and is to be send to the orders's
     * queue.
     * 
    ...
    /**
     * Create a message that triggers compensation and is to be send to the order's
     * queue.
     * 
     * @param data information to be passed to the saga participants
     * @return message to be sent to order
    ...
    /**
     * Handle reply from order service.
     * 
     * Set orderId to id generated by order service.
     * 
     * @param data  information to be passed to the saga participants
    ...
    /**
     * Create a message that triggers an action and is to be send to the inventory's
     * queue.
     * 
     * @param data information to be passed to the saga participants
    ...
    /**
     * Create a message that triggers compensation and is to be send to the
     * inventory's queue.
     * 
